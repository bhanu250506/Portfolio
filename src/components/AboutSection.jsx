...
export const AboutSection = () => {
  return (
    <section id="about" className="py-16 md:py-24 lg:py-32 px-4 relative bg-transparent">
      <div className="container mx-auto max-w-6xl">
        ...
        {/* GRID LOGIC:
            ...
            Tablet: grid-cols-2 (Better balance for medium screens)
            Desktop: grid-cols-3 (Your original wide layout)
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          */}
          ...
          >
            <SpotlightCard className="h-full p-6 sm:p-8 flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a href="https://linkedin.com/in/bhanupratapsn" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-all shadow-lg shadow-indigo-500/20">
                  <Linkedin className="w-4 h-4" /> LinkedIn
                </a>
                <a href="https://drive.google.com/file/d/1lTIFQTyUJqwCMYCTaAIOIvWr9LnUbGrN/view?usp=sharing" target="_blank" className="flex items-center justify-center gap-2 px-6 py-3 border border-slate-700 hover:border-white text-slate-300 hover:text-white rounded-lg font-medium transition-all">
          ...
          {/* Stats 
              Mobile: 1 col
              Tablet: 2 cols (Full width to fill gap)
              Desktop: 1 col (Side column)
          */}
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            <SpotlightCard className="h-full p-6 sm:p-8 flex flex-col justify-between bg-gradient-to-br from-slate-900/50 to-emerald-900/10">
              <div>
                 <div className="p-3 bg-emerald-500/10 w-fit rounded-xl border border-emerald-500/20 mb-6">
                  <BrainCircuit className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-400" />
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Problem Solver</h3>
                <p className="text-slate-400 text-sm">
                  Logic sharper than syntax. Solving complex algorithmic challenges daily.
                </p>
              </div>
              
              <div className="mt-8 pt-6 border-t border-slate-800">
                 <div className="text-4xl sm:text-5xl font-extrabold text-white mb-1">500+</div>
                 <div className="text-emerald-400 font-medium text-xs sm:text-sm uppercase tracking-wider">DSA Problems Solved</div>
          ...
          >
            <SpotlightCard className="p-6 h-full group">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Thriving on new frameworks. I adapt to technology shifts instantly to keep stack modern.
              </p>
            </SpotlightCard>
          </motion.div>
          ...
          >
            <SpotlightCard className="p-6 h-full group">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Scalable <strong>React</strong> web apps & <strong>Flutter</strong> mobile solutions with robust backends.
              </p>
            </SpotlightCard>
          </motion.div>
          ...
          >
            <SpotlightCard className="p-6 h-full group">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Patching vulnerabilities before deployment. OWASP Top 10 & Pen-Testing awareness.
              </p>
            </SpotlightCard>
          </motion.div>
